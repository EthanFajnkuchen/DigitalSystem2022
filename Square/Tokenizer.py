...
class Tokenizer:
    ...
    def command_type(self):
        ...
        if re.match(self.dictionary.get("KEYWORD"), self.current_command):
            return "keyword"
        elif re.match(self.dictionary.get("SYMBOLS"), self.current_command):
            return "symbol"
        elif re.match(self.dictionary.get("INTS"), self.current_command):
            return "integerConstant"
        elif re.match(self.dictionary.get("STRINGS"), self.current_command):
